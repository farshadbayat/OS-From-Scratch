...
extern "C"
{
	...
	enum FileOpenModeEnum{
		...
		FOpenModeWRTextAppend		= FOpenModeWrite | FOpenModeText  | FOpenModeAppend,
		FOpenModeWRBinaryAppend		= FOpenModeWrite | FOpenModeBinary| FOpenModeAppend,		
		FOpenModeRDWRTextAppend		= FOpenModeWrite | FOpenModeRead | FOpenModeText  | FOpenModeAppend	,
		FOpenModeRDWRBinaryAppend	= FOpenModeWrite | FOpenModeRead | FOpenModeBinary| FOpenModeAppend	,
		};
	...
	unsigned int CalculatFileSize(char *Path);
